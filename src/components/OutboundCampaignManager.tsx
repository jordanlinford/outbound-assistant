...
export default function OutboundCampaignManager() {
  ...
  const [prospects, setProspects] = useState<Prospect[]>([{ email: '' }]);
  ...
  const handleCreateCampaign = async () => {
    if (!config.name || prospects.length === 0 || !prospects[0].email) {
    ...
    try {
      const response = await fetch('/api/campaigns/outbound/create', {
        ...
        body: JSON.stringify({
          config,
          prospects: prospects.filter(p => p.email.trim())
        }),
      });
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-gray-900">Campaign Configuration</h4>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-md px-3 py-2"
                    placeholder="Schedule a 15-minute discovery call"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setConfig({ ...config, maxEmailsPerDay: parseInt(e.target.value) })}
                      className="w-full border border-gray-300 rounded-md px-3 py-2"
                      min="1"
                      max="200"
                    />
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <h4 className="font-medium text-gray-900">Prospects</h4>
                  <button
                    onClick={addProspect}
                  ...
                  {prospects.map((prospect, index) => (
                    <div key={index} className="border border-gray-200 rounded-md p-3">
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-sm font-medium text-gray-700">Prospect {index + 1}</span>
                        {prospects.length > 1 && (
                          <button
            ...
            <div className="flex justify-end space-x-3 mt-6 pt-4 border-t">
              ...
              >
                {loading ? 'Creating...' : 'Create Campaign with AI Sequences'}
              </button>
            </div>
          </div>
        </div>
