      ...
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-2 max-w-xl text-sm text-gray-500">
              <p>Detailed breakdown of your campaign metrics over time.</p>
            </div>
            <div className="mt-5">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-2 max-w-xl text-sm text-gray-500">
              <p>Your best performing campaigns by response rate.</p>
            </div>
            <div className="mt-5">
              <div className="bg-gray-50 rounded-lg p-6 text-center">
                <svg
                ...
                <p className="mt-2 text-sm text-gray-500">Campaign rankings will appear here</p>
              </div>
            </div>
          </div>
        </div>
