...
const navigation = [
  ...
  { name: 'LinkedIn Content', href: '/dashboard/linkedin', icon: PencilSquareIcon },
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <Menu as="div" className="relative">
                  ...
                  >
                    <Menu.Items className="absolute bottom-0 left-0 z-10 mt-2.5 w-32 origin-bottom-left rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <LogoutButton
                            className={classNames(
